...
- `docs/exec-plans/**`：执行计划属于工作状态：每份计划在数天内撰写、记录并移动，经评审的中文翻译在合并时即已过时。持久的 [PLANS 索引](../PLANS.md) 保持配对（[理由](../../.agents/notes/implemented/process/2026-08-15-harness-engineering-layer.md)）。
